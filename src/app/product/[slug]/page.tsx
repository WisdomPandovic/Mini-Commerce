        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 mt-6">
              <button
                className="w-full bg-black rounded text-white font-bold py-2 px-4 shadow-md hover:bg-white hover:text-black border border-black transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed uppercase"
